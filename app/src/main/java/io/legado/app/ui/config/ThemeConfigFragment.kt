...
class ThemeConfigFragment : PreferenceFragment(),
    ...
    private fun showBookshelfCoverAlphaDialog() {
        SeekBarDialog(requireContext())
            .setTitle(getString(R.string.bookshelf_cover_alpha))
            .setMaxValue(100)
            .setMinValue(0)
    ...
    private fun showDialogAlphaDialog() {
        SeekBarDialog(requireContext())
            ...
            .setCustomButton(R.string.btn_default_s) {
                putPrefInt(PreferKey.dialogAlpha, AppConfig.DEFAULT_DIALOG_ALPHA)
            }
            .show {
    ...
    private fun showDialogBlurDialog() {
        SeekBarDialog(requireContext())
            ...
            .setCustomButton(R.string.btn_default_s) {
                putPrefInt(PreferKey.dialogBlur, AppConfig.DEFAULT_DIALOG_BLUR)
            }
            .show {
